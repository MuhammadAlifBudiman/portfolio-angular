...
| F00B | Portfolio Showcase | FR-F00B-* | US-02 | AC-X-* | `docs/product/FEATURE_SPEC.md` | N/A | TBD | UAT + build | Done |
...
| F00E | README / Docs Correction | FR-F00E-* | N/A | N/A | `docs/product/FEATURE_SPEC.md` | TBD | TBD | docs review | Backlog |
