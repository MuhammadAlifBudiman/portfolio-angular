...
| F005 | Project Taxonomy, Featured Hierarchy & Filtering | FR-F005-1, FR-F005-2, FR-F005-3, FR-F005-4, FR-F005-5, FR-F005-6 | N/A | AC-F005-* | `docs/specs/F005-project-taxonomy/` | #57 | TBD | npm run build; npm test; project image check | In Progress |
...
| F008 | Project Detail / Case-Study Route | FR-F008-1, FR-F008-2, FR-F008-3, FR-F008-4 | N/A | AC-F008-* | `docs/specs/F008-project-detail/` | #57 | TBD | npm run build; npm test | Planned |
